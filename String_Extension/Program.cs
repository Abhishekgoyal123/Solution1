...
//String_Ext st = new String_Ext();

int a = str.WordCount();

Console.WriteLine($"Total word count is: {a}");

int b = str.StCount();

Console.WriteLine($"Total statement count is: {b}");

int c = str.SpchCount();

Console.WriteLine($"Total special character count is: {c}");

string d = str.ConvertF();
